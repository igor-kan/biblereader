# Contributing to biblereader

Thank you for your interest in contributing to biblereader! This document provides guidelines and instructions for contributing to this project.
...
2. **Clone your fork** locally:
   ```bash
   git clone https://github.com/YOUR_USERNAME/biblereader.git
   cd biblereader
   ```
3. **Add the upstream remote**:
   ```bash
   git remote add upstream https://github.com/igor-kan/biblereader.git
   ```
...
By contributing to biblereader, you agree that your contributions will be licensed under the project's [MIT License](LICENSE).
